...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/routes/selection/tabs.ipynb.

# %% auto #0
__all__ = ['init_tabs_router']

# %% ../../../nbs/routes/selection/tabs.ipynb #ca31d3ff
...
# %% ../../../nbs/routes/selection/tabs.ipynb #4d0109d3
def _handle_tab_switch(
    ...
    from cjm_fasthtml_workflow_transcript_decomp.routes.selection.core import _update_step_state
...
# %% ../../../nbs/routes/selection/tabs.ipynb #qaovu542uyo
