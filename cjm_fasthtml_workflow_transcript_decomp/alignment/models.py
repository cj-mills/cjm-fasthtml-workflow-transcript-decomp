...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/alignment/models.ipynb.

# %% auto #0
__all__ = ['AlignmentStepState', 'VADChunk', 'AlignmentUrls']

# %% ../../nbs/alignment/models.ipynb #align-models-imports
...
# %% ../../nbs/alignment/models.ipynb #align-models-state
...
# %% ../../nbs/alignment/models.ipynb #align-models-chunk
@dataclass
class VADChunk:
...
# %% ../../nbs/alignment/models.ipynb #align-models-urls
@dataclass
class AlignmentUrls:
