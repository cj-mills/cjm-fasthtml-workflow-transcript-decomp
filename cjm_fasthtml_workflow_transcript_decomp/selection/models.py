...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/selection/models.ipynb.

# %% auto #0
__all__ = ['SelectionStepState', 'SelectionUrls']

# %% ../../nbs/selection/models.ipynb #selection-models-imports
...
# %% ../../nbs/selection/models.ipynb #selection-step-state
...
# %% ../../nbs/selection/models.ipynb #selection-urls
@dataclass
class SelectionUrls:
