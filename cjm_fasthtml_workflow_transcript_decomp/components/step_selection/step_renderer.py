...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/components/step_selection/step_renderer.ipynb.

# %% auto #0
__all__ = ['SD_FOCUSED_JOB_ID_INPUT', 'SD_FOCUSED_PLUGIN_INPUT', 'SD_TOGGLE_BTN', 'SD_REMOVE_BTN', 'SD_REORDER_UP_BTN',
...
from ...routes.models import SelectionUrls
...
# Step selection submodule imports
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #lexm9ngrt8p
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #52i7b5ddglt
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #8d397d19
def _render_selection_stats(
    ...
    total_words = 0
    selected_job_ids = {s.get("job_id") for s in selected_sources}
    for t in transcriptions:
        if t.get("job_id") in selected_job_ids:
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #anw0emkui8i
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #ef027dd5
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #g5dxecaghmn
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #02153354
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #cr0nj457spi
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #mtoysvv63qq
...
# %% ../../../nbs/components/step_selection/step_renderer.ipynb #5n0esq0hg67
def render_selection_step(
    ...
    include_selector = f"#{SD_FOCUSED_JOB_ID_INPUT}, #{SD_FOCUSED_PLUGIN_INPUT}"
