...
# %% auto #0
__all__ = ['render_decomp_mini_stats_badge', 'render_align_mini_stats_badge', 'render_combined_step']
...
# %% ../../nbs/components/step_combined.ipynb #3x5ezeou2d3
...
def render_combined_step(
    ...
    switch_chrome_url:str="",  # URL for chrome switching route (unused until 4d)
    ...
    if is_align_init and align_urls:
        # Render alignment column body from state (no keyboard system yet)
