...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/decomposition/models.ipynb.

# %% auto #0
__all__ = ['WorkingSegment', 'DecompositionStepState', 'DecompUrls']
...
# %% ../../nbs/decomposition/models.ipynb #working-segment
@dataclass
...
# %% ../../nbs/decomposition/models.ipynb #decomp-urls
@dataclass
class DecompUrls:
