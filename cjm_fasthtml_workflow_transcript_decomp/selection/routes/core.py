...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/selection/routes/core.ipynb.

# %% auto #0
__all__ = ['DEBUG_SELECTION_STATE']

# %% ../../../nbs/selection/routes/core.ipynb #sel-core-imports
...
# %% ../../../nbs/selection/routes/core.ipynb #sel-core-getters
def _get_step_state(
...
# %% ../../../nbs/selection/routes/core.ipynb #3zll5oy1hsc
...
# %% ../../../nbs/selection/routes/core.ipynb #syxdwqpy9uj
def _build_queue_response(
    ...
    if include_source_list and _get_active_source_tab(workflow, session_id) == "db":
        source_list_kwargs = {}
...
# %% ../../../nbs/selection/routes/core.ipynb #sel-core-update
