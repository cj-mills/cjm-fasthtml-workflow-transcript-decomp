...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/decomposition/utils.ipynb.

# %% auto #0
__all__ = ['count_words', 'word_index_to_char_position', 'calculate_segment_stats']

# %% ../../nbs/decomposition/utils.ipynb #seg-utils-imports
from typing import List, Dict, Any, TYPE_CHECKING

if TYPE_CHECKING:
    from cjm_fasthtml_workflow_transcript_decomp.decomposition.models import TextSegment

# %% ../../nbs/decomposition/utils.ipynb #seg-utils-count-words
def count_words(
...
# %% ../../nbs/decomposition/utils.ipynb #seg-utils-word-index-to-char
...
# %% ../../nbs/decomposition/utils.ipynb #seg-utils-calc-stats
