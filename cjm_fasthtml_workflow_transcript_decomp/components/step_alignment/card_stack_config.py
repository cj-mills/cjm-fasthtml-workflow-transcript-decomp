...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/components/step_alignment/card_stack_config.ipynb.

# %% auto #0
__all__ = ['ALIGN_CS_CONFIG', 'ALIGN_CS_IDS', 'ALIGN_CS_BTN_IDS']

# %% ../../../nbs/components/step_alignment/card_stack_config.ipynb #align-csc-exports
...
# %% ../../../nbs/components/step_alignment/card_stack_config.ipynb #align-csc-config
